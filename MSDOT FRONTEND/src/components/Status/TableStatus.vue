...
import ModalStatus from '@/components/Status/ModalStatus.vue';

export default {
  props: ["data"],
  components: {ModalStatus,ModalDelete},
  data() {
    return {
      showModal: false,
      deleteModal: false,
    ...
    >
      <thead>
        <tr class="bg-blue-500 text-center font-bold uppercase">
          ...
          <th class="pt-2 pr-10">Status Name</th>
