...
import ModalMediaType from '@/components/MediaType/ModalMediaType.vue';

export default {
  props: ["data"],
  components: {ModalMediaType,ModalDelete},
  data() {
    return {
      showModal: false,
      deleteModal: false,
  ...
  methods: {
    ...
    deleteMediaType(id) {
      this.$emit('deletemediaType', id );
      this.showDeleteModal = false;
    },
    editMediaType (newData) {
      console.log(newData);
      this.$emit('editmediaType', newData );
      this.showModal = false;
    },
    addMediaType (newData) {
      console.log(newData);
      this.$emit('addmediaType',newData);
      this.showModal = false;
    },
  },
};
    ...
    >
      <thead>
        <tr class="bg-blue-500 text-center font-bold uppercase">
          ...
          <th class="pt-2 pr-10">MediaType</th>
          ...
          <td class="flex items-center justify-center">
            ...
            <Teleport to="#Modal">
              ...
              <ModalDelete
                ...
                @deleteprogress="deleteMediaType"
