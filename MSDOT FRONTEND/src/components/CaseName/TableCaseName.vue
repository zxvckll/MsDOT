...
import ModalCaseName from '@/components/CaseName/ModalCaseName.vue';

export default {
  props: ["data"],
  components: {ModalCaseName,ModalDelete},
  data() {
    return {
      showModal: false,
      deleteModal: false,
  ...
  methods: {
    ...
    deleteCaseName(id) {
      this.$emit('deletecaseName', id );
      this.showDeleteModal = false;
    },
    editCaseName (newData) {
      console.log(newData);
      this.$emit('editcaseName', newData );
      this.showModal = false;
    },
    addCaseName (newData) {
      console.log(newData);
      this.$emit('addcaseName',newData);
      this.showModal = false;
    },
  },
};
    ...
    >
      <thead>
        <tr class="bg-blue-500 text-center font-bold uppercase">
          ...
          <th class="pt-2 pr-10">CaseName</th>
        ...
        >
          ...
          <td class="flex items-center justify-center">
            ...
            <Teleport to="body">
              ...
              <ModalCaseName
                :data="!this.data ? null :this.selectedData"
                :show="showModal"
