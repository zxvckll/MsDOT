...
import ModalCase from '@/components/Case/ModalCase.vue';

export default {
  props: ["data","DataCaseName","DataCaseType"],
  components: {ModalCase,ModalDelete},
  data() {
    return {
      showModal: false,
      deleteModal: false,
  ...
  methods: {
    ...
    editCase (newData) {
      console.log(newData);
      this.$emit('editcase', newData );
      this.showModal = false;
    },
    addCase (newData) {
      console.log(newData);
      this.$emit('addcase',newData);
      this.showModal = false;
    },
  },
};
    ...
    >
      ...
      <tbody>
        ...
        >
          ...
          <td>{{ datta.CaseName.name ? datta.CaseName.name : '' }}</td>
          <td>{{ datta.CaseType.name ? datta.CaseType.name : '' }}</td>
          ...
          <td class="flex items-center justify-center">
            ...
            <Teleport to="#Modal">
              ...
              <ModalCase
                :CaseName="this.DataCaseName"
                :CaseType="this.DataCaseType"
